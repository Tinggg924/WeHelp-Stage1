...
def book(consultants, hour, duration, criteria):
    global available_schedules
    if not available_schedules:
        for the_consultant in consultants:
            available_schedules[the_consultant["name"]] = set()
    ...
    for criteria_priority in criteria_select:
        schedule = available_schedules[criteria_priority["name"]]
        no_overlap = True
